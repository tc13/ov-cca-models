Code to accompany manuscript **"Natural History of a parasite-induced biliary cancer"**. The scripts run in R version 4.3.3. Note the package dependencies at the beginning of the scripts. 
